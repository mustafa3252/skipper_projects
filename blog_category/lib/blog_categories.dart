...
class BlogCategories extends StatefulWidget {
  const BlogCategories({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: TextField(
                      onChanged: (value) => {blogCategory = value},
                      maxLines: 1,
                      decoration: const InputDecoration(
                        hintText: "Name of the Blog Category",
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: TextButton(
                        ...
                        onPressed: () =>
                            createBlogCategory(blogCategory, des, statusValue),
                        child: const Center(
                          child: Text(
                            "Submit",
                            style:
