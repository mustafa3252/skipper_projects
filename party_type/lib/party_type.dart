...
class PartyType extends StatefulWidget {
  const PartyType({Key? key}) : super(key: key);

  @override
  State<PartyType> createState() => _PartyTypeState();
}

class _PartyTypeState extends State<PartyType> {
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: TextField(
                      onChanged: (value) => {partyType = value},
                      maxLines: 1,
                      decoration: const InputDecoration(
                        hintText: "Name of the Party Type",
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: TextButton(
                        ...
                        onPressed: () =>
                            createPartyTypeData(partyType, des, statusValue),
                        child: const Center(
                          child: Text(
                            "Submit",
                            style:
